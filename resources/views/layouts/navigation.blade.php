<nav class="border-b border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-900">
    ...
    <div class="mx-auto px-4 transition-[max-width] sm:px-6 lg:px-8" :class="wideLayout ? 'max-w-[1600px]' : 'max-w-7xl'">
        <div class="flex h-16 justify-between">
            ...
            <div class="hidden sm:ms-6 sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none dark:bg-gray-900 dark:text-gray-300 dark:hover:text-white">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="menuOpen = ! menuOpen" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none dark:hover:bg-gray-800 dark:focus:bg-gray-800">
